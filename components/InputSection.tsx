          ...
          <div>
            ...
            >
             ...
             <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                   <label className="block text-[10px] text-gray-500 font-bold">运营成本率 (%)</label>
                   <input 
                     type="number" step="0.1"
                     className="w-full text-sm border-gray-300 rounded" 
                     value={config.cangjingOperationalCostPercent} 
                     onChange={(e) => onConfigChange({ cangjingOperationalCostPercent: Number(e.target.value) })}
                   />
                </div>
             </div>
             <div className="mt-2">
                 ...
                 <input 
                   type="number" step="0.1"
                   className="w-full text-sm border-gray-300 rounded" 
                   value={config.cangjingLogisticsCostPercent} 
                   onChange={(e) => onConfigChange({ cangjingLogisticsCostPercent: Number(e.target.value) })}
                 />
            </div>
          </div>
